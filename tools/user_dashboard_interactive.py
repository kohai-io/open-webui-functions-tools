...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>📊 Admin Dashboard <span style="font-size: 14px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 4px 12px; border-radius: 12px; font-weight: 500; margin-left: 12px;">v2.1.15</span></h1>
...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Welcome back, {user_name}! <span style="font-size: 14px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 4px 12px; border-radius: 12px; font-weight: 500; margin-left: 12px;">v2.1.15</span></h1>
